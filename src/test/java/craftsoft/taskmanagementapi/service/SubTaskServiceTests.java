...
import craftsoft.taskmanagementapi.dao.SubTaskRepository;
...
import craftsoft.taskmanagementapi.service.impl.SubTaskServiceImpl;
...
public class SubTaskServiceTests {
    ...
    void test_updateSubTask() {
        ...
        Optional<SubTask> subTask = Optional.of(new SubTask(1, "Subtask", "description", Status.DONE, task));
        Optional<SubTask> emptyTask = Optional.empty();
        SubTaskRequestDTO subTaskRequestDTO = new SubTaskRequestDTO(1, "Subtask", "description", Status.DONE);
        SubTaskRequestDTO wrongSubTaskRequestDTO = new SubTaskRequestDTO(2, "Subtask", "description", Status.DONE);
